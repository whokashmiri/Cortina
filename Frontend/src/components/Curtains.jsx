...
const Curtains = () => {
  ...
  const products = [
    ...
    {
      id: 2,
      image: "https://images.unsplash.com/photo-1614590302821-3d96b26788ec?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-6xl font-bold text-center mb-8 text-gray-900">
        The Elegant <span className="text-teal-800 font-light">Curtains</span>
      </h1>
